      ...
      <div className="flex flex-wrap items-center justify-between gap-4 mb-4 bg-white/80 p-3 rounded-2xl border border-slate-200 shadow-sm backdrop-blur-md">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="px-3.5 py-1.5 bg-emerald-600 hover:bg-emerald-700 text-white text-xs font-bold rounded-xl flex items-center gap-2 transition-all shadow-sm cursor-pointer disabled:opacity-50"
          >
